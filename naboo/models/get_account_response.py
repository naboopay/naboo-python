...
class GetAccountResponse(BaseModel):
    ...
    account_is_activate: StrictBool
    method_of_payment: Wallet
    loyalty_credit: StrictInt
    __properties: ClassVar[List[str]] = ["account_number", "balance", "account_is_activate", "method_of_payment", "loyalty_credit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "account_is_activate": obj.get("account_is_activate"),
            "method_of_payment": obj.get("method_of_payment"),
            "loyalty_credit": obj.get("loyalty_credit")
        })
        return _obj
